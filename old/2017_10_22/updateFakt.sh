#!/bin/bash
#sprawdzacz statusu i s³uchalno¶ci radyjek

home='/home/hobbit/skrypty/fakt' #katalog domowy skryptu
source='/home/hobbit/skrypty/fakt/source' #katalog plików ¼ród³owych
fileSource='/home/hobbit/skrypty/fakt/source/fakt' #katalog paczki
packName='0001pop.zip' #nazwa paczki
tmp='/tmp' #tymczasowy
dbName="fakt" #nazwa bazy
dbUser="fakt" #nazwa uzytkownika bazy
dbPass="memory" #has³o do bazy
dbHost="localhost" #adres hosta bazy
aDate=`date +%F`
aTime=`date +%+65H:%M:%S`
